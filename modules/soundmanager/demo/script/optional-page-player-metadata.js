  ...
  this.refreshMetadata = function(oSound) {
    ...
    if (index !== metadata.currentItem) {
	  ...
	  if (index < metadata.length && soundManager.radioclashSpecialFeatures) {
		...
		if (document.getElementById(oSound._data.oLink.id + 'metadataShortCut' + index).getAttribute('class') == null)
			classAttributeName = 'className';
	  
		 if (metadata.currentItem != null)
			document.getElementById(oSound._data.oLink.id + 'metadataShortCut' + metadata.currentItem).setAttribute(classAttributeName, "metadataShortCut");
			//document.getElementById('metadataShortCut' + metadata.currentItem).style.color = "black";

		document.getElementById(oSound._data.oLink.id + 'metadataShortCut' + index).setAttribute(classAttributeName, "metadataShortCutPlaying");
