...
<script language="javascript">
	function showContenu (item) {
		alert('Change le contenu du milieu du site pour n\'afficher que les éléments de type : ' + item);
	}
</script>
...
-->
			...
			<!-- Menu -->
			<!--
			<li class="itemEmission itemMenu">
				<a href="#top" title="Voir les news" onclick="javascript:showContenu('news');">NEWS</a>
				<span class="separator">|</span>
				<a href="#top" title="Voir les mixes" onclick="javascript:showContenu('mixes');">MIXES</a>
				<span class="separator">|</span>
				<a href="#top" title="Voir les bonus" onclick="javascript:showContenu('bonus');">BONUS</a>
				<span class="separator">|</span>
				<a href="#top" title="Voir tout" onclick="javascript:showContenu('all');">TOUT</a>			
			</li>
-->
			<!-- Exemple de news / bonus -->
			<li class="itemEmission itemAutre itemNews">
				<div class="titreNews">
				<?php
