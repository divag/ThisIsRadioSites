	...
	<div id="content">
		<ul class="listeEmissions">
			...
			<li class="itemEmission itemMenu itemMenuEntete">
				<?php
					echo "<a href=\"".$lienFacebook."\" class=\"exclude\"><img src=\"css/facebook.ico\" class=\"icon\" />&nbsp;<span>FACEBOOK</span></a>";
					echo "<span class=\"separator\">|</span>";
					echo "<a href=\"".$lienForum."\" class=\"exclude\"><img src=\"css/musiques_incongrues.png\" class=\"icon\" />&nbsp;<span>FORUM</span></a>";
					echo "<span class=\"separator\">|</span>";
					echo "<a href=\"".$lienPodcast."\" class=\"exclude\"><img src=\"css/rss.png\" class=\"icon\" />&nbsp;<span>PODCAST / RSS</span></a>";
					echo "<span class=\"separator\">|</span>";
					echo "<a href=\"#\" class=\"exclude\" onclick=\"window.open('http://feedburner.google.com/fb/a/mailverify?uri=Prototop', 'popupwindow', 'scrollbars=yes,width=550,height=520');return true\"><img src=\"css/email.png\" class=\"icon\" />&nbsp;<span>MAILING-LIST</span></a>";
					echo "<span class=\"separator\">|</span>";
					echo "<a href=\"".$lienTwitter."\" class=\"exclude\"><img src=\"css/twitter.ico\" class=\"icon\" />&nbsp;<span>TWITTER</span></a>";
					/*
			...
			<li class="itemEmission itemAutre itemHeader siteHeader">
					<img src="css/prototop2.jpg" alt="Prototop" align="center" />
					<!--<img src="css/prototop.jpg" alt="Prototop" align="center" width="65%" />
					-->
					<!--
					<br />
			...
			<li class="itemEmission itemMenu menuLiensContenu">
				...
				<span class="separator">|</span>
				<a href="#top" title="Voir les liens" onclick="javascript:showContenu('liens');" class="lienliens">LIENS</a>
			</li>
		</ul>
		<ul class="listeEmissions contenu">
			...
			<!-- Liens -->
			<li class="itemEmission itemAutre itemNews item liens">
				<div class="titreNews">
				<?php
					$contenuTitreLiens = dbGetContenuPageSite($id_site, 'index', 'liens_titre');
					if ($contenuTitreLiens != 0)
					{
						echo $contenuTitreLiens['contenu_fr']."\n";
					}
				?>
				</div>
				<div class="presentation">
				<?php
					$contenuLiens = dbGetContenuPageSite($id_site, 'index', 'liens_texte');
					if ($contenuLiens != 0)
					{
